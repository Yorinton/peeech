        ...
        <div class="col-md-8 col-md-offset-2 pt20 text_align_c">
            <header class="header hero_img">
                <div class="wd100 ht100 header_content">
                    <div class="text_align_c">
                        ...
                        <h2><img alt="Peeech" class="wd90" src="../../images/top/logo.png" alt="Peeech"></h2>
                    </div>
            ...
            <section class="convert_to_max_size_of_page section_bg_color fc_white pl15 pr15">
                ...
                <div class="mb30">
                    ...
                    <img alt="共通点やしたいことで繋がろう" class="wd100" src="../../images/top/second_01.png">
                </div>
                <div>
                    <img alt="画面キャプチャ" class="wd80" src="../../images/top/second_02.png">
                </div>
            </section>
            <section>
                <h3 class="fw_b mb35 mt35">こんなことありませんか？</h3>                
                <div class="mb50">
                    <img alt="年代 地域 性別 推し 握手会 ライブ 振りコピ" class="wd80 img_box_shadow" src="../../images/top/needs_01.png">
                    <p class="mt25 fs16 fw_b">共通点があって気の合うファン友と<br>一緒にファン活動を楽しみたい</p>
                </div>
                <div class="mb50">
                    <img alt="ライブ画像" class="wd80 img_box_shadow" src="../../images/top/needs_02.png">
                    <p class="mt25 fs16 fw_b">ライブや握手会楽しみ！<br>でもぼっち参加でちょっと寂しい</p>
                </div>
                <div class="mb50">
                    <img alt="同行者募集" class="wd80 img_box_shadow" src="../../images/top/needs_03.png">
            ...
            <section class="convert_to_max_size_of_page section_bg_color fc_white pl15 pr15 pb5">
                ...
                <div>
                    <img alt="自分にピッタリ したいことや共通点が同じ" class="wd80 img_box_shadow" src="../../images/top/miryoku_01.png">
                ...
                <div>
                    <img alt="一緒に楽しもう" class="wd80 img_box_shadow" src="../../images/top/miryoku_02.png">
                ...
                <div>
                    <img alt="アイドル好き専用" class="wd80 img_box_shadow" src="../../images/top/miryoku_03.png">
            ...
            <section>
                ...
                <div>
                    <img alt="気軽に誘える" class="wd80 img_box_shadow" src="../../images/top/invite_01.png">
                ...
                <div>
                    <img alt="専用プロフィール" class="wd80 img_box_shadow" src="../../images/top/invite_02.png">
            ...
            <section class="pt20 sepalator_top">
                ...
                <div>
                    <img alt="合う人をレコメンド" class="wd80 img_box_shadow" src="../../images/top/use_01.png">
                    <h4 class="fw_b mt25 mb50">プロフィール入力後<br>希望に合った人をレコメンド</h4>
                </div>
                <div>
                    <img alt="興味あり・なし" class="wd80 img_box_shadow" src="../../images/top/use_02.png">
                    <h4 class="fw_b mt25 mb50">興味ありor興味なしを選択</h4>
                </div>
                <div>
                    <img alt="メッセージ" class="wd80 img_box_shadow" src="../../images/top/use_03.png">
                    <h4 class="fw_b mt25 mb30">マッチングしたら<br>メッセージを送ってみよう</h4>
                </div>
                <div class="text_align_c">
                    <img alt="↓" class="wd10" src="../../images/icons/arrow.png">
                </div>
                <div>
