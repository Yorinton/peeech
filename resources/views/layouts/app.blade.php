 ...
 -->                    </button>
        ...
        <footer class="footer">
            <div class="container sp-between">
                <a class="text_align_c wd25 menu_footer" href="{{ url('/friends/'.Auth::user()->id) }}"><img class="wd80 menu1" src="{{ asset('images/icons/menu_no_color/menu1_2.png',$is_production) }}"></a>
